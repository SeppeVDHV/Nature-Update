...
public record ModPiglinOffers(HolderLookup.Provider registries) implements LootTableSubProvider {
    @Override
                        ...
                        LootPool.lootPool()
                                ...
                                .add(
                                        LootItem.lootTableItem(Items.BOOK)
                                                .setWeight(5)
                                                .apply(new EnchantRandomlyFunction.Builder().withEnchantment(registries.getOrThrow(Enchantments.SOUL_SPEED)))
                                )
                                .add(
                                ...
                                .add(
                                        LootItem.lootTableItem(ModItems.NETHER_ESSENCE.get())
                                        .setWeight(40)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(6f, 14f)))
                                )
                )
        );
    }
